    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-[100] flex h-[10vh] min-h-[10vh] w-full items-center bg-[#FEFFFF]/95 backdrop-blur-sm">
            <nav className="mx-auto flex h-full w-[85%] items-center justify-between font-sans">
                {/* Logo */}
                <Link to="/" className="flex items-center text-2xl font-bold tracking-tight z-[120]">
                ...
                <div className="flex items-center justify-end lg:gap-12 gap-6">
                    ...
                    <button
                        ...
                        className="md:hidden relative z-[120] flex h-12 w-12 items-center justify-center rounded-2xl border border-gray-200/80 bg-white/90 shadow-[0_4px_24px_rgba(19,135,174,0.12)] backdrop-blur-sm transition-shadow hover:shadow-[0_8px_28px_rgba(126,20,135,0.15)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1387AE]/40"
                    >
                ...
                {menuOpen && (
                    <>
                        <motion.button
                            ...
                            className="md:hidden fixed inset-0 z-[105] bg-[#0f172a]/45 backdrop-blur-[2px]"
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            exit={{ opacity: 0 }}
                        ...
                        <motion.div
                            ...
                            className="md:hidden fixed inset-y-0 right-0 z-[110] flex w-[min(100%,20rem)] flex-col overflow-hidden border-l border-white/60 bg-gradient-to-b from-[#FEFFFF] via-[#F0F9FF] to-[#E8E0FF]/90 shadow-[-12px_0_48px_rgba(19,135,174,0.18)]"
                            variants={menuPanel}
                            initial="closed"
                            animate="open"
                            exit="exit"
                        >
                            ...
                            <div className="relative flex flex-1 flex-col px-6 pb-8 pt-[calc(10vh+0.5rem)]">
                                <p className="mb-6 text-[10px] font-semibold uppercase tracking-[0.35em] text-gray-400">
                                    Navigate
                                </p>
                                        ...
                                        return (
                                            <motion.li key={href} variants={staggerItem}>
                                                <Link
                                                    to={href}
                                                    onClick={closeMenu}
                                                    className={`group flex items-baseline gap-3 rounded-xl py-3 pl-2 pr-3 transition-colors ${
